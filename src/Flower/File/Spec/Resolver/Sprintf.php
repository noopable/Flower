 ...
 */
class Sprintf implements ResolveSpecInterface, ListenerAggregateInterface
{
    protected $config;
    ...
    public function configure()
    {
        ...
        if (isset($config['path_spec'])) {
            $this->pathSpec = $config['path_spec'];
        }
    ...
    public function setResolver(ResolverInterface $resolver = null)
    {
         ...
         */
        $options = array();
        if (isset($this->pathSpec)) {
            $options['path_spec'] = $this->pathSpec;
        }

        if (isset($this->param)) {
            $options['param'] = $this->param;
        }
        $this->resolver = new Resolver\SprintfPath($options);
