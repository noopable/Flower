 ...
 */
class NpMenu extends AbstractHelper
{
    /**
     ...
     */
    protected $filterContainerClass = 'Flower\View\Navigation\FilterContainer';

    /**
     * filter for FilterContainer
     *
     * @var callale
     */
    protected $filter;
    ...
    protected function renderNormalMenu(
        ...
        // create iterator
        if (isset($this->filterContainerClass) && isset($this->filter)) {
            $container = new $this->filterContainerClass($container);
            $container->setFilter($this->filter);
        }
    ...
    public function setFilter($filter)
    {
        if (!is_callable($filter)) {
            throw new \RuntimeException('please set callale filter');
        }
        $this->filter = $filter;
    }
}
