<?php
namespace FlowerTest\Resource\Mapper;


use Flower\Resource\Mapper\Mapper as ResourceMapper;
...
class MapperTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Flower\Resource\Mapper\Mapper::addStrategy
     */
    ...
    /**
     * @covers Flower\Resource\Mapper\Mapper::setStrategies
     */
    ...
    /**
     * @covers Flower\Resource\Mapper\Mapper::entityToResource
     */
    public function testEntityToResource()
    {
        ...
        $this->assertInstanceOf('Flower\Resource\ResourceClass\Resource', $res);
        
        //not object returns null
        $res = $this->object->entityToResource(array('entity'));
        $this->assertInstanceOf('Flower\Resource\ResourceClass\PhpArray', $res);
        
        //not object returns null
        $res = $this->object->entityToResource(123);
        $this->assertInstanceOf('Flower\Resource\ResourceClass\Scalar', $res);
    ...
    /**
     * @covers Flower\Resource\Mapper\Mapper::objectToResourceWithStrategy
     */
