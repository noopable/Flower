...
use Flower\View\Pane\ListHelperFactory;
...
class ListHelperFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProtectedProperties()
    {
        ...
        $this->assertEquals('Flower\View\Pane\ListPaneHelper', TestTool::getPropertyValue($this->object, 'helperClass'));
    }
    /**
    ...
    public function testCreateService()
    {
        ...
        $this->assertInstanceof('Flower\View\Pane\ListPaneHelper', $helper);
        return $helper;
    }
