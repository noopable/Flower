...
class RegistryEventManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->object->getEventManager()->setSharedManager(StaticEventManager::getInstance());
    }
    ...
    public function testAttachWithId()
    {
        $id = array('foo', 'bar');
        $event = 'update';
        ...
        $sharedManager->expects($this->once())
                ->method('attach')
                ->with($this->equalTo($id), $this->equalTo($event), $this->equalTo($callback), $this->equalTo($priority));
        $this->object->getEventManager()->setSharedManager($sharedManager);
        $this->object->attachWithId($id, $event, $callback, $priority);
    }
    ...
    public function testGetSharedEventManager()
    {
        $eventManager = new EventManager;
        $this->object->setEventManager($eventManager);
        $shared = $this->object->getSharedEventManager();
        $this->assertInstanceOf('Zend\EventManager\SharedEventManager', $shared);
    }
}
